...
from book.models import Category, Group, Image, Product
from book.serializers import CategoryModelSerializer, GroupModelSerializer, ImageSerializer, ProductSerializer
